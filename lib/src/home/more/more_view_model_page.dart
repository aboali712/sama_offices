...
abstract class MoreViewModelPage  extends State<MorePageScreen> with StorageHelper{
  String token="";
            ...
            child: Padding(
              ...
              child: Column(
                ...
                Container(
                  ...
                  child: Align(
                    ...
                    child: Text(
                      ...
                      style: const TextStyle(
                          fontSize: fontTextTitle, fontWeight: FontWeight.w400),
                    ),
                  ),
                ),
                    const SizedBox(height: 20,),
                  ...
                  child: Container(width:MediaQuery.of(context).size.width-100,height: 50,decoration: BoxDecoration(borderRadius: BorderRadius.circular(10),
                        ...
                        children: [
                          Row(children: [
                            ClipRRect(borderRadius: BorderRadius.circular(50),
                              ...
                              child: Image.asset("assets/images/flag.png",height: 30,width: 30,fit: BoxFit.cover,),
                            ),
                            const SizedBox(width: 20,),
                            Text("العربية",style: GoogleFonts.tajawal(fontWeight: FontWeight.w600,fontSize: 16)),
                            ...
                            builder:(_,v,__) =>
                                Container(height: 25,width: 25,
                                    decoration: BoxDecoration(borderRadius: BorderRadius.circular(50),
                                        color:lang.value=="ar"? samaColor :Colors.white),
                                    child: const Icon(Icons.done,color: Colors.white,size: 19,)
                                )    ,
                          ),
                        ...
                        children: [
                          Row(children: [
                            ClipRRect(borderRadius: BorderRadius.circular(50),
                              ...
                              child: Image.asset("assets/images/flagUsa.png",height: 30,width: 30,fit: BoxFit.cover,),
                            ),
                            const SizedBox(width: 20,),
                            Text("English",style: GoogleFonts.tajawal(fontWeight: FontWeight.w600,fontSize: 16)),
                          ...
                          ValueListenableBuilder(
                            ...
                            builder:(_,v,__) =>
                                Container(height: 25,width: 25,
                                    decoration: BoxDecoration(borderRadius: BorderRadius.circular(50),color:lang.value=="en"? samaColor :Colors.white),
                                    child: const Icon(Icons.done,color: Colors.white,size: 19,)
                                )    ,
                          ),
                        ],
